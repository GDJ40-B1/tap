...
public interface QuestionMapper {
	...
	List<Question> unansweredQuestionList(Map<String, Object> paramMap);	// 미답변 문의 글 조회
	int unansweredRowCount(String writerCategory);							// 미답변 문의 페이지 수 체크
	int unansweredQuestionCount();											// 미답변 문의 수 체크
	...
	int updateAnswerCheck(QuestionAnswer questionAnswer);					// 문의 답변 여부 체크
}
